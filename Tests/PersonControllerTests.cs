...
public class PersonsControllerTests
{
    ...
    public async Task Index_ShouldReturnViewWithFilteredAndSortedPersons()
    {
        ...
        _personsServiceMock.Verify(x => x.GetFilteredAsync(searchBy, searchValue), Times.Once);
        _personsServiceMock.Verify(x => x.GetSorted(persons, orderBy, sortOrder), Times.Once);
    }
    ...
    public async Task Index_WithDefaultValues_ShouldUseDefaults()
    {
        ...
        model.SearchBy.Should().BeNull();
        model.SearchValue.Should().BeNull();
    ...
    public async Task Create_Post_InvalidModel_ShouldReturnSameView()
    {
        ...
        var errors = _sut.ViewBag.Errors as List<string>;
        var viewBagCountries = _sut.ViewBag.Countries as List<SelectListItem>;

        errors.Should().NotBeNull();
        errors.Should().Contain("Person Name can't be Blank");

        viewBagCountries.Should().NotBeNull();
        viewBagCountries.Should().HaveCount(countries.Count);

        _personsServiceMock.Verify(x => x.AddAsync(It.IsAny<PersonAddRequest>()), Times.Never);
    }
    ...
    public async Task Create_Post_ValidModel_ShouldAddPersonAndRedirect()
    {
        ...
        _personsServiceMock.Setup(x => x.AddAsync(request)).ReturnsAsync(response);
        ...
        _personsServiceMock.Verify(x => x.AddAsync(request), Times.Once);
    }
    #endregion
    ...
    public async Task Edit_Get_ValidId_ShouldReturnViewWithPerson()
    {
        ...
        _personsServiceMock.Setup(x => x.GetByIdAsync(personId)).ReturnsAsync(person);
        ...
        _personsServiceMock.Verify(x => x.GetByIdAsync(personId), Times.Once);
        _countriesServiceMock.Verify(x => x.GetAllAsync(), Times.Once);
    }

    [Fact]
    public async Task Edit_Post_InvalidModel_ShouldReturnViewWithErrors()
    {
    ...
    public async Task Edit_Post_ValidModel_ShouldUpdateAndRedirect()
    {
        ...
        _personsServiceMock.Setup(x => x.GetByIdAsync(request.Id)).ReturnsAsync(existingPerson);
        ...
        _personsServiceMock.Verify(x => x.UpdateAsync(request), Times.Once);
    }
    ...
    public async Task Delete_Post_InvalidModel_ShouldReturnViewWithErrors()
    {
        ...
        _personsServiceMock.Verify(x => x.DeleteAsync(It.IsAny<Guid>()), Times.Never);
    }
    ...
    public async Task Delete_Post_ValidModel_ShouldDeleteAndRedirect()
    {
        ...
        _personsServiceMock.Setup(x => x.GetByIdAsync(person.Id)).ReturnsAsync(person);

        _personsServiceMock.Setup(x => x.DeleteAsync(person.Id)).ReturnsAsync(true);
        ...
        _personsServiceMock.Verify(x => x.DeleteAsync(person.Id), Times.Once);
    }
    ...
    public async Task DownloadPersonsCsv_ShouldReturnCsvFile()
    {
        ...
        _personsServiceMock.Setup(x => x.GetPersonsCsvAsync()).ReturnsAsync(csvBytes);
        ...
        _personsServiceMock.Verify(x => x.GetPersonsCsvAsync(), Times.Once);
    }
    ...
    public async Task DownloadPersonsExcel_ShouldReturnExcelFile()
    {
        ...
        _personsServiceMock.Setup(x => x.GetPersonsExcelAsync()).ReturnsAsync(excelBytes);
        ...
        _personsServiceMock.Verify(x => x.GetPersonsExcelAsync(), Times.Once);
    }
