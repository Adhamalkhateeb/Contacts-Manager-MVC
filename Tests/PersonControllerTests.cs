...
public class PersonsControllerTests
{
    ...
    {
        return _fixture.Build<PersonResponse>()
            .With(p => p.Name, "Adham")
    ...
    {
        return _fixture.Build<CountryResponse>()
            .CreateMany(2)
            .ToList();
    }
    ...
    public async Task Index_WithDefaultValues_ShouldUseDefaults()
    {
        ...
        _personsServiceMock
            .Setup(x => x.GetSorted(It.IsAny<List<PersonResponse>>(),
                nameof(PersonResponse.Name), SortOrder.ASC))
            .Returns(persons);
    ...
    public async Task Edit_Post_InvalidModel_ShouldReturnViewWithErrors()
    {
        ...
        _sut.ModelState.AddModelError(nameof(PersonUpdateRequest.Name), "Person Name can't be Blank");
        ...
        _personsServiceMock.Verify(x => x.UpdateAsync(It.IsAny<PersonUpdateRequest>()), Times.Never);
    ...
    public async Task Edit_Post_ValidModel_ShouldUpdateAndRedirect()
    {
        // Arrange
        var request = _fixture.Create<PersonUpdateRequest>();
        var existingPerson = _fixture.Build<PersonResponse>()
    ...
    public async Task Delete_Post_ValidModel_ShouldDeleteAndRedirect()
    {
        ...
        _personsServiceMock
            .Setup(x => x.DeleteAsync(person.Id))
            .ReturnsAsync(true);
    ...
    public async Task DownloadPersonsExcel_ShouldReturnExcelFile()
    {
        ...
        _personsServiceMock
            .Setup(x => x.GetPersonsExcelAsync())
