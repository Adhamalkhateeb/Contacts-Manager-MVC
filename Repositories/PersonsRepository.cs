...
public class PersonsRepository : IPersonsRepository
{
    ...
    {
        return await _context.Persons.Where(p => p.Id == personId).ExecuteDeleteAsync();
    }

    public async Task<IEnumerable<Person>> GetAllAsync()
    {
        return await _context.Persons.AsNoTracking().Include(p => p.Country).ToListAsync();
    }
    ...
    public async Task<IEnumerable<Person>> GetFilteredAsync(
